...
void RGBCycler::calculateRGB(float progress, RGBColor * color)
{
  color->setRed(redCurve(progress));
  color->setGreen(greenCurve(progress));
  color->setBlue(blueCurve(progress));
}
